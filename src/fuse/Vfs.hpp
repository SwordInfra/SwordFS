...
class VfsHookFactory {
 ...
 public:
  ...
  static void SwordFsMknod(fuse_req_t req, fuse_ino_t parent, const char *name, mode_t mode, dev_t rdev);
  static void SwordFsMkdir(fuse_req_t req, fuse_ino_t parent, const char *name, mode_t mode);
  ...
  static void SwordFsSymlink(fuse_req_t req, const char *link, fuse_ino_t parent, const char *name);
  static void SwordFsRename(fuse_req_t req, fuse_ino_t parent, const char *name, fuse_ino_t newparent,
                            const char *newname, unsigned int flags);
  static void SwordFsLink(fuse_req_t req, fuse_ino_t ino, fuse_ino_t newparent, const char *newname);
  static void SwordFsOpen(fuse_req_t req, fuse_ino_t ino, struct fuse_file_info *fi);
  static void SwordFsRead(fuse_req_t req, fuse_ino_t ino, size_t size, off_t off, struct fuse_file_info *fi);
  static void SwordFsWrite(fuse_req_t req, fuse_ino_t ino, const char *buf, size_t size, off_t off,
                           struct fuse_file_info *fi);
  static void SwordFsFlush(fuse_req_t req, fuse_ino_t ino, struct fuse_file_info *fi);
  static void SwordFsRelease(fuse_req_t req, fuse_ino_t ino, struct fuse_file_info *fi);
  static void SwordFsFsync(fuse_req_t req, fuse_ino_t ino, int datasync, struct fuse_file_info *fi);
  static void SwordFsOpendir(fuse_req_t req, fuse_ino_t ino, struct fuse_file_info *fi);
  static void SwordFsReaddir(fuse_req_t req, fuse_ino_t ino, size_t size, off_t off, struct fuse_file_info *fi);
  static void SwordFsReleasedir(fuse_req_t req, fuse_ino_t ino, struct fuse_file_info *fi);
  static void SwordFsFsyncdir(fuse_req_t req, fuse_ino_t ino, int datasync, struct fuse_file_info *fi);
  static void SwordFsStatfs(fuse_req_t req, fuse_ino_t ino);
  static void SwordFsSetxattr(fuse_req_t req, fuse_ino_t ino, const char *name, const char *value, size_t size,
                              int flags);
  ...
  static void SwordFsSetlk(fuse_req_t req, fuse_ino_t ino, struct fuse_file_info *fi, struct flock *lock, int sleep);
  static void SwordFsBmap(fuse_req_t req, fuse_ino_t ino, size_t blocksize, uint64_t idx);
  ...
  static void SwordFsFallocate(fuse_req_t req, fuse_ino_t ino, int mode, off_t offset, off_t length,
                               struct fuse_file_info *fi);
  static void SwordFsReaddirplus(fuse_req_t req, fuse_ino_t ino, size_t size, off_t off, struct fuse_file_info *fi);
  static void SwordFsCopyFileRange(fuse_req_t req, fuse_ino_t ino_in, off_t off_in, struct fuse_file_info *fi_in,
                                   fuse_ino_t ino_out, off_t off_out, struct fuse_file_info *fi_out, size_t len,
                                   int flags);
  static void SwordFsLseek(fuse_req_t req, fuse_ino_t ino, off_t off, int whence, struct fuse_file_info *fi);
  static void SwordFsTmpfile(fuse_req_t req, fuse_ino_t parent, mode_t mode, struct fuse_file_info *fi);
  static void SwordFsStatx(fuse_req_t req, fuse_ino_t ino, int flags, int mask, struct fuse_file_info *fi);
};
