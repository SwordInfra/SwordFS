...
class ConfigCenter {
 public:
  ...
  int fuse_threads() const {
    return fuse_threads_;
  }
  int storage_thread_count() const {
    return storage_thread_count_;
  }
  int meta_thread_count() const {
    return meta_thread_count_;
  }
