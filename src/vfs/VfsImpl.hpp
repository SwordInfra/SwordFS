...
class VfsImpl {
 public:
  ...
  static utils::Status Rename(fuse_ino_t parent, const char *name, fuse_ino_t newparent, const char *newname,
                              unsigned int flags);
  static utils::Status Link(fuse_ino_t ino, fuse_ino_t newparent, const char *newname, fuse_entry_param *entry);
  static utils::Status Open(fuse_ino_t ino, struct fuse_file_info *fi);
  static utils::Status Read(fuse_ino_t ino, size_t size, off_t off, uint64_t fh, std::unique_ptr<folly::IOBuf> *data);
  ...
  static utils::Status Readdir(fuse_req_t req, fuse_ino_t ino, size_t size, off_t off, std::string *buf);
  static utils::Status Readdirplus(fuse_req_t req, fuse_ino_t ino, size_t size, off_t off, std::string *buf);
